...
public interface IDaoBoard {
     ...
     */
    public abstract ModelArticle getNextArticle(ModelArticle updateValue, ModelArticle searchValue);

    /*
     * 이전글 보기 articleNo,boardCd,searchWord->HahMap 에 담는다
     */
    public abstract ModelArticle getPrevArticle(ModelArticle updateValue, ModelArticle searchValue);

    /*
     * 첨부파일
     */
    public abstract ModelAttachfile getAttachFile(ModelAttachfile attachfileno);
